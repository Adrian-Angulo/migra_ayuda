...
import 'package:migra_ayuda/features/entities/presentation/widgets/entity_detail_card.dart';
...
class _ExplorarScreenState extends ConsumerState<ExplorarScreen>
              ...
              children: [
                ...
                MapView(
                  ...
                  onMarkerTap: (entity) {
                    ...
                    // Minimiza el sheet cuando se selecciona un marcador
                    if (_isControllerAttached && _sheetController.isAttached) {
                    ...
                    CategorySelector(
                      ...
                      onSelected: (index) {
                        setState(() {
                          ...
                          _showDetailCard =
                              false; // Oculta la tarjeta al cambiar filtro
                        });
                      },
                    ),
                    ...
                    child: _showDetailCard && _selectedEntity != null
                        ? EntityDetailCard(
                            ...
                            onClose: () {
                              ...
                              // Vuelve al tamaño normal del sheet
                            ...
                            children: [
                              ...
                              Expanded(
                                child: _buildEntitiesList(
                                    filteredEntities, scrollController),
                              ),
                            ],
                          ),
                  ),
  ...
  Widget _buildEntitiesList(
      List<EntityEntity> entities, ScrollController scrollController) {
    if (entities.isEmpty) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
        ...
        itemBuilder: (context, index) {
          ...
          return PlaceCard(
            ...
            onTap: () {
              ...
              // Expande el sheet para mostrar los detalles
              if (_isControllerAttached && _sheetController.isAttached) {
                _sheetController.animateTo(
                  0.50,
                  duration: const Duration(milliseconds: 300),
